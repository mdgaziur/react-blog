...
function AllPosts() {
    ...
    useEffect(() => {
        paginatePosts(posts, setPosts, Indice, setIndice, setIsPostLoading, setMaxIndice);
    }, []);
        ...
        <div>
            {
                ...
                <div className="allposts">
                    <h1 style={{ textAlign: "center" }}>{strings.all_posts}</h1>
                ...
                :
                !isPostLoading && <h1 style={{textAlign:"center"}}>There are no posts in this blog</h1>
            }
        </div>
    );
}
