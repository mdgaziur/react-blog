...
import getPostJson from "../../utils/getPostJson";
...
function NewPost() {
    ...
    useEffect(() => {
        ...
        setPostId(post_id);
        getPostJson(post_id, setPostData, setPostTitle, setThumbnailUrl, setPreviewImage);
    }, []);
    ...
    async function createPost() {
        ...
        if (!title) {
            ...
            await editPost(title, postId,category, data, thumbnailUrl, accessToken, errors, setErrors);
        }
    }
    return (
            ...
            </div>
            {
                ...
                <div className="post-creator">
                    ...
                    <div className="input-container">
                        ...
                        <input type="text" id="post-title" value={postTitle} onChange={e => setPostTitle(e.target.value)}></input>
                    </div>
                    <div className="input-container">
                    ...
                    <div className="input-container" style={{ alignItems: "center" }}>
                        ...
                        {
                            Object.keys(user).length > 0 && Object.keys(post_data).length > 0 &&
                            <EditorJs
